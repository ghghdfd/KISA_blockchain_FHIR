...
public class Diagnosis_seoul extends Composition {
...
//
	...
	public boolean isEmpty() {
		return super.isEmpty() && ElementUtil.isEmpty(Certainty,MainDiagnosis,MainDiagnosisKCD,SubDiagnosis,SubDiagnosisKCD,
				onsetdate,diagnosisdate,TreatmentContentAndNote,AdmissionDate,
				DischargeDate,Remark,Perpose,Content,Certification,Providername);
	}
