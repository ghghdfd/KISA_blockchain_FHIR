...
public class Birthcertificate_samsung extends Composition {
    ...
    */
	...
	public boolean isEmpty() {
		return super.isEmpty() && ElementUtil.isEmpty(Fathername,Fatherage,Mothername, Motherage, Motheraddress,PlaceOfBirth,
				DateOfBirth,Babygender,Babyweight,PregnancyPeriod,Multiple,Birthorderamongmultiple,Babycondition,
