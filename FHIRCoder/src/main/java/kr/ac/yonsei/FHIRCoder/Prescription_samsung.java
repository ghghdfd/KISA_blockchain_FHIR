...
//   * 보험종류: Composition.extension.InsuranceType
...
public class Prescription_samsung extends Composition {
    ...
    */
	...
	@Child(name = "InsuranceType")   
	@Extension(url = "http://yonsei.ac.kr/Type of InsuranceType", definedLocally=false, isModifier=false)
	@Description(shortDefinition = "Type of Insurance")
	private org.hl7.fhir.r4.model.Extension InsuranceType;
	
	public org.hl7.fhir.r4.model.Extension getInsuranceType() {
		return InsuranceType;
	}

	public void setInsuranceType(org.hl7.fhir.r4.model.Extension InsuranceType) {
...
//
	...
	public boolean isEmpty() {
		return super.isEmpty() && ElementUtil.isEmpty(InsuranceType,KCD,Department,Providername, CertificationType,Certification,
