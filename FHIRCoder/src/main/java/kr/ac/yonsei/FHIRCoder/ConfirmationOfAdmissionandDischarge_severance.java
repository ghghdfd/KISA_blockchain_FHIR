...
public class ConfirmationOfAdmissionandDischarge_severance extends Composition {
...
//
	...
	@Child(name = "Periodofadmission")   
	@Extension(url = "http://yonsei.ac.kr/Periodofadmission", definedLocally=false, isModifier=false)
	@Description(shortDefinition = "Period of admission")
	private org.hl7.fhir.r4.model.Extension Periodofadmission;
	
	public org.hl7.fhir.r4.model.Extension getPeriodofadmission() {
		return Periodofadmission;
	}

	public void setPeriodofadmission(org.hl7.fhir.r4.model.Extension Periodofadmission) {
		this.Periodofadmission = Periodofadmission;
	}	
