 ...
 * 발행번호: Composition.id
 * 수납일자: Composition.extension.date
...
public class ProofOfPayment_seoul extends Composition {
	    ...
	    */
		...
		public boolean isEmpty() {
			return super.isEmpty() && ElementUtil.isEmpty(paidbypatient, paidbyplan, Optionalexpenses, paidtotal, paidbycreditcard, 
					paidbycashreceipt, paidbycash, Department);
		}
	}
