...
// 보장구		item.productOrService
// 진단서 및 증명료		item.productOrService
// 치과병원진료비		item.productOrService
...
public class ProofOfPaymentDSCH_severance extends Composition {
