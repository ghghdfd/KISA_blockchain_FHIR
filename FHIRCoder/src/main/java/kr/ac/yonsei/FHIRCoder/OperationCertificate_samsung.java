...
//* 주소: Composition.subject.Patient.Address
//* 연락처: Composition.subject.Patient.telecom.other
//* 휴대전화번호: Composition.subject.Patient.telecom.phone
...
//* 수술이력: Composition.extension.OperationHistory
...
public class OperationCertificate_samsung extends Composition {
...
//
	...
	@Child(name = "OperationHistory")   
	@Extension(url = "http://yonsei.ac.kr/OperationHistory", definedLocally=false, isModifier=false)
	@Description(shortDefinition = "History of Operation")
	private org.hl7.fhir.r4.model.Extension OperationHistory;
	
	public org.hl7.fhir.r4.model.Extension getOperationHistory() {
		return OperationHistory;
	}

	public void setOperationHistory(org.hl7.fhir.r4.model.Extension OperationHistory) {
	...
	public boolean isEmpty() {
		return super.isEmpty() && ElementUtil.isEmpty(Certainty,MainDiagnosis,MainDiagnosisKCD,SubDiagnosis,SubDiagnosisKCD,
				onsetdate,diagnosisdate,OperationHistory,Remark,Perpose,Content,Certification,Providername);
	}
