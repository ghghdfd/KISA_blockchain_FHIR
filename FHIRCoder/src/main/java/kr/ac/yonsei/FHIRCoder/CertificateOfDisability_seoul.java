...
public class CertificateOfDisability_seoul extends Composition {
    ...
    */
	...
	@Child(name = "StateOfDisability")   
	@Extension(url = "http://yonsei.ac.kr/StateOfDisability", definedLocally=false, isModifier=false)
	@Description(shortDefinition = "State of disability")
	private org.hl7.fhir.r4.model.Extension StateOfDisability;
	
	public org.hl7.fhir.r4.model.Extension getStateOfDisability() {
		return StateOfDisability;
	}
	public void setStateOfDisability(org.hl7.fhir.r4.model.Extension StateOfDisability) {
		this.StateOfDisability = StateOfDisability;
	}
	...
	@Description(shortDefinition = "Name of Certifiacte isser")
	...
	public boolean isEmpty() {
		return super.isEmpty() && ElementUtil.isEmpty(Requestername,Requesteridentifier,Requesteraddress,
				Disabilityperson,Disabilitypersonidentifier,RelationshipWithRequester,StateOfDisability,PeriodOfDisability,
				ContentOfDisability,Perpose,Content,Providername,Issuer);
