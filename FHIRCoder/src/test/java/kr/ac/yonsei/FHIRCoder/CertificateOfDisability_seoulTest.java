...
public class CertificateOfDisability_seoulTest {
	public static void main(String[] args) {
		CertificateOfDisability_seoul pop = new CertificateOfDisability_seoul();

		Narrative value = new Narrative();
		value.setDivAsString("<div>KISA 2020 블록체인 프로젝트; FHIR 프로파일링 장애인증명서(서울대); Authored by Jaehoon Lee Date: 2020-07-20</div>");
		pop.setText(value);
		...
		adresss.setDistrict("종로구 대학로 101");
		address.add(adresss);
		...
		StringType StateOfDisability = new StringType();
		StateOfDisability.fromStringValue("비영구");
		pop.setStateOfDisability(new org.hl7.fhir.r4.model.Extension("http://yonsei.ac.kr/State of disability", (IBaseDatatype) StateOfDisability));		

	
		StringType PeriodOfDisability = new StringType();
		PeriodOfDisability.fromStringValue("0000년 00월 00일  부터  0000년 00월 00일 까지");
		...
		Issuer.fromStringValue("서울대학교병원");
		pop.setIssuer(new org.hl7.fhir.r4.model.Extension("http://yonsei.ac.kr/Name of Certifiacte isser", (IBaseDatatype) Issuer));		
