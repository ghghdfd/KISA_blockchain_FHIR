...
public class Birthcertificate_samsungTest {
	public static void main(String[] args) {
		Birthcertificate_samsung pop = new Birthcertificate_samsung();
		
		pop.setId("2018-92750");

		Narrative value = new Narrative();
		value.setDivAsString("<div>KISA 2020 블록체인 프로젝트; FHIR 춠생증명서(삼성서울); Authored by Jaehoon Lee Date: 2020-07-20</div>");
		pop.setText(value);
		...
		Fatherage.fromStringValue("0000년 00월 00일생 만 00세");
		...
		Motherage.fromStringValue("0000년 00월 00일생 만 00세");
		...
		Motheraddress.fromStringValue("**리");
		...
		PlaceOfBirth.fromStringValue("서울특별시 강남구 일원로 81 삼성서울병원");
		...
		Babyweight.fromStringValue("0.7 Kg");
		...
		PregnancyPeriod.fromStringValue("00주 00일");
		...
		Babyphysicalcondition.fromStringValue("추후관찰요망");
		...
		Babyhealthcondition.fromStringValue("추후관찰요망");
