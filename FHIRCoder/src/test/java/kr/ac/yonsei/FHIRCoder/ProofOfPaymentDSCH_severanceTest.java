...
public class ProofOfPaymentDSCH_severanceTest {
	
	public static void main(String[] args) {
		ProofOfPaymentDSCH_severance pop = new ProofOfPaymentDSCH_severance();
		// 영수증번호
		...
		n.setDivAsString("<div>KISA 2020 블록체인 프로젝트; FHIR 프로파일링 진료비 계산 영수증(중간); Authored by Jaehoon Lee Date: 2020-07-24</div>");
		pop.setText(n);
		...
		// 사업자등록번호
		org.setId("110-82-00472");
		
		// 사업장 소재지
		List<Address> theAddress = new ArrayList<Address>();
		Address address = new Address();
		address.setText("서울시 서대문구 연세로 50-1");
