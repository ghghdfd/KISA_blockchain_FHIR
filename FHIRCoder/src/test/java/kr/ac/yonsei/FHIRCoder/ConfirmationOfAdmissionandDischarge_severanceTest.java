...
public class ConfirmationOfAdmissionandDischarge_severanceTest {
	public static void main(String[] args) {
		ConfirmationOfAdmissionandDischarge_severance pop = new ConfirmationOfAdmissionandDischarge_severance();
		pop.setId("2020-10-A2");
		...
		value.setDivAsString("<div>KISA 2020 블록체인 프로젝트; FHIR 프로파일링 입퇴원증명서(진단명 포함); Authored by Jaehoon Lee Date: 2020-07-20</div>");
		pop.setText(value);
		...
		Diagnosis.fromStringValue("폐암(소세포암)(C34.99) 뇌로 전이(C79.30) 뼈로 전이(C79.50)");
		...
		Periodofadmission.fromStringValue("2019-08-06 ~ 2019-08-14");
